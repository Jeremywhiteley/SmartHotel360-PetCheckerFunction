...
echo "Deploying Cognitive Vision servicw to $rgName in $location"
az group create -g $rgName -l $location
az group deployment create -g $rgName --template-file cognitive.json --parameters name=$baseName
echo "Deploy done!"
